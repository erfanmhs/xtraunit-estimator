...
export const GUIDE: Record<GuideKey, GuideEntry> = {
  ...
  takeoff: {
    ...
    steps: [
      ...
      { do: "Each kind of measurement gets its own layer. The first time you draw walls you get “Layer 1” — start measuring straight away. Switching tools takes you back to your last layer of that kind. Tap the layer chip to give it a real name (“Exterior walls”) or to continue an earlier layer of the same kind.", note: "A layer holds one kind of measurement, so areas and counts never mix. Every run you draw goes into the layer on the chip — tap it for “＋ New layer” (a second layer of the same kind: east walls, then west walls), to continue an earlier layer, or to stop drawing. Hold a run on the sheet to edit, move or delete it." },
  ...
  scope: {
    ...
    steps: [
      ...
      { do: "Under the trades, “Not included in this price” is exactly what the client will read as left out, grouped by trade: things a trade’s work leaves out, whole items taken out of the bid, what the AI noted while reading the plans, and your standard list from Settings. Fix the wording, put an item back in the scope, hide it, or delete it for good.", note: "Hiding a standard item changes this job only — the wording stays in Settings." },
    ],
