...
export const GUIDE: Record<GuideKey, GuideEntry> = {
  ...
  takeoff: {
    ...
    steps: [
      ...
      { do: "Each tool gets its own layer, named “Layer 1”, “Layer 2”… as you switch — start measuring straight away. Tap the layer chip to give it a real name (“Exterior walls”) or to continue an earlier layer of the same kind.", note: "A layer holds one kind of measurement, so areas and counts never mix. The red ● next to the chip is Record: taps add to the layer while it’s on; tap it to pause, tap again to record." },
